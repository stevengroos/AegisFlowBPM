...
export default function EwCarsLanding() {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 font-sans text-zinc-900 dark:text-zinc-100 selection:bg-red-600 selection:text-white transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-red-600 rounded-xl flex items-center justify-center shadow-lg shadow-red-600/30">
              <CarFront size={24} className="text-white" strokeWidth={1.5} />
            </div>
            <span className="font-black text-2xl tracking-tighter uppercase italic">EW CARS</span>
          </div>
      ...
      {/* HERO SECTION (Estilo Garage Premium) */}
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400 font-bold text-xs uppercase tracking-widest mb-6">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6 uppercase italic text-zinc-900 dark:text-white">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-400">de tu vehículo.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a 
              href="https://www.aegisflowbpm.com/c/37" 
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-full text-lg font-bold shadow-xl shadow-red-600/20 transition-all hover:-translate-y-1"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-y border-zinc-800 py-16">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="w-16 h-16 bg-zinc-800 text-red-500 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-red-600 group-hover:text-white transition-all duration-300 transform group-hover:-translate-y-2">
      ...
      {/* SHOWROOM (Imagen proporcionada) */}
      <section id="showroom" className="py-24 bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-12">
            
            <div className="flex-1 space-y-6">
              <h2 className="text-4xl font-black uppercase italic tracking-tight">Visita nuestra<br/><span className="text-red-600">Boutique Automotriz</span></h2>
              ...
              <ul className="space-y-3 pt-4">
                <li className="flex items-center gap-3 font-bold text-zinc-800 dark:text-zinc-200">
                  <CheckCircle2 className="text-red-600" size={20}/> Alfombras Ultra Mats & Heavy Duty
                </li>
                <li className="flex items-center gap-3 font-bold text-zinc-800 dark:text-zinc-200">
                  <CheckCircle2 className="text-red-600" size={20}/> Exhibición de volantes deportivos
                </li>
                <li className="flex items-center gap-3 font-bold text-zinc-800 dark:text-zinc-200">
                  <CheckCircle2 className="text-red-600" size={20}/> Taller de instalación integrado
                </li>
              </ul>
            </div>

            <div className="flex-1 w-full">
              <div className="relative rounded-3xl overflow-hidden shadow-2xl dark:shadow-red-900/10 border-4 border-white dark:border-zinc-800 group">
                <img 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-3">
             <div className="w-8 h-8 bg-zinc-900 dark:bg-white rounded-lg flex items-center justify-center transition-colors">
              <CarFront size={18} className="text-white dark:text-zinc-900" />
            </div>
            <span className="font-black tracking-tight text-zinc-900 dark:text-white uppercase italic">EW Cars</span>
          </div>
          ...
          <div className="flex items-center gap-6 text-zinc-500 dark:text-zinc-400 text-sm font-medium">
            ...
            <a href="https://www.aegisflowbpm.com/c/37" className="hover:text-red-600 dark:hover:text-red-500 transition-colors uppercase tracking-wider text-xs font-bold">Ir al Catálogo</a>
          </div>
        </div>
      </footer>
