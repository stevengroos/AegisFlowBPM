...
import { ArrowRight, Speaker, Tv, ChefHat, ShoppingBag, ShieldCheck, MapPin } from 'lucide-react';

export default function SolYLunaLanding() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 font-sans text-gray-900 dark:text-gray-100 selection:bg-blue-500 selection:text-white">
      
      {/* NAVEGACIÓN */}
      <nav className="fixed w-full z-50 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <a 
            ...
            className="flex items-center gap-2 bg-gray-900 dark:bg-white text-white dark:text-gray-900 px-4 py-2 rounded-full text-sm font-bold hover:scale-105 transition-transform"
          >
            <ShoppingBag size={16} />
            Ver Catálogo
          </a>
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a 
              href="#galeria" 
              className="w-full sm:w-auto flex items-center justify-center gap-2 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 text-gray-700 dark:text-gray-300 px-8 py-4 rounded-full text-lg font-bold hover:bg-gray-50 dark:hover:bg-gray-800 transition-all"
            >
              Conocer el local
            </a>
          </div>
      ...
      {/* CATEGORÍAS (Basadas en tus fotos) */}
      ...
      {/* GALERÍA BENTO (Tus fotos reales) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-[300px]">
            ...
            <div className="md:col-span-8 rounded-3xl overflow-hidden relative group">
              <img 
                src="/images/solyluna/tienda-panoramica.jpg" 
            ...
            <div className="md:col-span-4 rounded-3xl overflow-hidden relative group">
              <img 
                src="/images/solyluna/electrodomesticos.jpg" 
            ...
            {/* Foto Parlantes */}
            <div className="md:col-span-12 rounded-3xl overflow-hidden relative group h-[400px]">
              <img 
                src="/images/solyluna/parlantes.jpg" 
      ...
      <footer className="bg-white dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold tracking-tight">Sol y Luna Electrónica</span>
          </div>
          
          <div className="flex items-center gap-6 text-gray-500 text-sm">
            <span className="flex items-center gap-1"><MapPin size={14}/> Luque, Paraguay</span>
            <a href="https://www.aegisflowbpm.com/c/10" className="hover:text-blue-600 transition-colors">Ir al Catálogo</a>
          </div>
        </div>
      </footer>
      ...
      >
        ...
        <span className="absolute right-16 bg-gray-900 text-white text-xs font-bold px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap">
          ¿Necesitas ayuda?
        </span>
      </a>
    </div>
